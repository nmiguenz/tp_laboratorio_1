...
int al_clear(ArrayList* this)
{
    ...
    if (this!=NULL)
    {
        auxPElement = realloc(this->pElements,AL_INITIAL_VALUE);
        if (auxPElement !=NULL)
        {
            this->size = 0;
            this->reservedSize = AL_INITIAL_VALUE;
...
ArrayList* al_clone(ArrayList* this)
{
    ...
    if (this !=NULL)
    {
        ...
        int arrayCloneSize;
        arrayCloneSize=(this->size);
        returnAux=al_newArrayList();

        for(i=0;i<arrayCloneSize;i++)
        {
...
int al_containsAll(ArrayList* this,ArrayList* this2)
{
    ...
    if(this!=NULL && this2!=NULL)
    {
        ...
        {
            datoAux=al_get(this2,i);
            if(!al_contains(this,datoAux))
            {
...
int al_sort(ArrayList* this, int (*pFunc)(void* ,void*), int order)
{
    ...
    if(this != NULL && (order == 0 || order == 1) && pFunc != NULL)
    {
        for(i=1; i<(this->size); i++)
        {
            ...
            auxPElement = al_get(this, i);
            j=i-1;

            while((j >= 0 && pFunc(auxPElement, al_get(this, j)) == -1 && order == 1) || (j >= 0 && pFunc(auxPElement, al_get(this, j)) == 1 && order == 0))
            {
                al_set(this, j+1, al_get(this, j));
                j--;
            }

            al_set(this, j+1, auxPElement);
...
int expand(ArrayList* this,int index)
{
    ...
    if(this!=NULL && index>=0)
    {
        ...
        if(al_len(this)>=0 && index>=0 && index<=al_len(this))
        {
            this->size++;
...
int contract(ArrayList* this,int index)
{
    ...
    if(this!=NULL)
    {
        ...
        if(al_len(this)>0 && index<al_len(this) && index>=0)
        {
